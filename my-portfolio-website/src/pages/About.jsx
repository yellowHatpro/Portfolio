...
export const About = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("scroll", () =>
      setScrollPosition(
        Math.min(Math.max(window.scrollY * 2, 0), window.innerWidth / 2 + 20),
      ),
    );
    return () => {
        ...
        >
          ...
          <div className={"flex flex-col p-2 items-center"}>
            ...
            <h1 className={"text-lg font-light text-justify"}>
              Hello everyone, I am Ashutosh Aswal, aka yellowhatpro. A final
              year BTech student from PEC, Chandigarh, graduating in 2024.
